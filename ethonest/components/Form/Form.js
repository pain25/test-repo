...
const Form = () => {
  ...
  //setStoryUrl will store the url of the image
  //storyUrl will wait for the async response of Url which setStoryUrl will be taking
  //same for imageUrl and setImageUrl
  ...
  const startCampaign = async (e) => {
    ...
    //to get the adress of the signer
    ...
    if (form.campaignTitle === "") {
      ...
      const campaignData = await contract.createCampagin(
        form.campaignTitle,
        CampaignAmount,
        imageUrl,
        form.category,
